...
public protocol MIDIManagerDelegate {
	func scheduleMIDINote(on: Bool, noteNumber: UInt8, at velocity: UInt8)
	func scheduleCCFor(_ cc: UInt8, with data: UInt8)
	func schedulePitchBendWith(lsb: UInt8, msb: UInt8)
}
